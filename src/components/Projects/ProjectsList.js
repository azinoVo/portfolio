const projectsList = [
    ...
    },
    {
        ...
        "description": "Restaurant review application that uses a REST-ful backend to manipulate data via CRUD operations. Solely worked on the Backend and helped debug the Frontend.",
